...
| `LQL-F41` | `equals_common_case` / `contains_common_case` | in progress | no | `ROWS` | `API` | P3 | Source-audit and live-oracle work is pinning Go simple Unicode case expansion, phrase boundaries, grammar, and bounded combination state before shipment. |
