...
|---|---:|---|
| `extension_workspace` | `0.8.1` | Current extension/core/dbhealth source line. |
| `server_workspace` | `0.8.1` | Current metrics/logs/traces server source line. |
...
### Behavior changes on the 0.7 line
...
x86-64/AArch64 macOS. For `v0.8.1`, all four native build, identity,
...
permanent `v0.8.1` GitHub Release assets (the tag→Release path first proven
