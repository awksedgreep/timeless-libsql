...
| `PQL-R06` | `last_over_time` ([SQL](QUERY_SQL_EQUIVALENTS.md#sql-prom-025-last_over_time)); exact last IEEE bits, boundaries, subqueries, exceptional metric-name retention, limits, cancellation, and reopen are pinned | in progress | yes | `RAW`, `SQL` | `API` | P0 |
