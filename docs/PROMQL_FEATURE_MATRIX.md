...
| `PQL-S07` | positive and negative `offset` ([SQL](QUERY_SQL_EQUIVALENTS.md#sql-prom-008-temporal-selector-modifiers)) | in progress | yes | `RAW`, `GRID`, `SQL` | `API` | P0 | `session_three_promql_temporal_modifiers_preserve_selection_and_output_time` pins signed planner shifts through the real extension. |
| `PQL-S08` | `@ timestamp`, `@ start()`, `@ end()` ([SQL](QUERY_SQL_EQUIVALENTS.md#sql-prom-008-temporal-selector-modifiers)) | in progress | yes | `RAW`, `GRID`, `SQL` | `API` | P0 | The same contract pins fixed selection instants, outer output timestamps, modifier order, range/function behavior, and reopen. |
...
| `PQL-O05` | one-to-one vector matching ([SQL](QUERY_SQL_EQUIVALENTS.md#sql-prom-004-vector-arithmetic-with-label-matching)) | missing | yes | `SQL` | `API` | P0 |
...
|---|---|---|---|---|---|---|
| `PQL-R01` | `avg_over_time` ([SQL](QUERY_SQL_EQUIVALENTS.md#sql-prom-002-avg_over_time)) | shipped | yes | `WINDOW` | `API` | P0 |
| `PQL-R02` | `min_over_time` | missing | yes | `WINDOW` | `API` | P0 |
...
| `PQL-R06` | `last_over_time` | missing | yes | `WINDOW`, `RAW` | `API` | P0 |
| `PQL-R07` | `first_over_time` | missing | yes | `WINDOW`, `RAW` | `API` | P0 |
| `PQL-R08` | `present_over_time` | missing | yes | `WINDOW` | `API` | P0 |
...
|---|---|---|---|---|---|---|
| `PQL-F01` | `abs` | missing | yes | `SQL` | `API` | P0 |
| `PQL-F02` | `ceil`, `floor`, `round` | missing | yes | `SQL` | `API` | P0 |
