...
| `PQL-R04` | `sum_over_time` ([SQL](QUERY_SQL_EQUIVALENTS.md#sql-prom-023-sum_over_time)); compensated cancellation, overflow, IEEE values, exact boundaries, subqueries, limits, cancellation, and reopen are pinned | in progress | yes | `WINDOW`, `RAW` | `API` | P0 |
