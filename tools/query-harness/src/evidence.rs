    ...
    let result = (|| {
        ...
        for (key, name, expression, expected, expected_total) in [
            ...
            (
                ...
                r#"host:="h00" AND query | fields range_key | format '1 2023-06-03T17:42:00Z bench-host bench-app 1 ID47 - <range_key>' as packed | unpack_syslog from packed result_prefix decoded_ | limit 64 | fields decoded_message"#,
                64,
                None,
            ),
            (
                ...
                r#"query | fields range_key | format '1 2023-06-03T17:42:00Z bench-host bench-app 1 ID47 - <range_key>' as packed | unpack_syslog from packed result_prefix decoded_ | limit 64 | fields decoded_message"#,
                64,
                None,
            ),
            (
                ...
                r#"host:="h00" AND query | fields range_key | format '1 2023-06-03T17:42:00Z bench-host bench-app 1 ID47 - <range_key>' as packed | copy range_key as decoded_message | limit 64 | fields decoded_message"#,
                64,
                None,
            ),
            (
                ...
                r#"query | fields range_key | format '1 2023-06-03T17:42:00Z bench-host bench-app 1 ID47 - <range_key>' as packed | copy range_key as decoded_message | limit 64 | fields decoded_message"#,
                64,
                None,
            ),
            (
