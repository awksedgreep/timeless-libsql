...
`clamp`, `clamp_min`, `clamp_max`, `sqrt`, `exp`, `ln`, `log2`, and `log10`
...
the executable `abs`, `ceil`, `floor`, `round`, clamp, square-root,
exponential, and logarithm recipes over
